...
import StitchRequestsPage from '../../pages/stitch-requests-page';
...
import RecycleBinPage from '../../pages/recycle-bin-page';
import ReturnRequestsPage from '../../pages/return-requests-page';
import StorefrontSettingsPage from '../../pages/storefront-settings-page';
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AdminShell />}>
          ...
          <Route path="/stitch-requests" element={<StitchRequestsPage />} />
