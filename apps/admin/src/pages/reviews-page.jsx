...
export default function ReviewsPage() {
  ...
  const handleSaveReply = async (reviewId) => {
    try {
      await updateAdminReviewReply(reviewId, {
      ...
      setState((prev) => ({
        ...prev,
        error: error?.response?.data?.message || 'Unable to save review reply.',
      }));
    }
  };
        ...
        {state.loading ? (
          ...
          state.items.map((item) => (
            ...
            >
              ...
              <div className="mt-5 space-y-3 rounded-[8px] border border-[#171412]/10 bg-[#f6f3ee] p-4">
                <label className="text-xs uppercase text-[#756c63]">
                  Admin reply
                </label>
                <textarea
                  rows={3}
                  ...
                  placeholder="Example: Thank you for trusting us and ordering from PARSOM ATTIRE."
