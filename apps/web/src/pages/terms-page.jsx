...
const sections = [
  {
    title: 'Overview',
    points: [
      'These terms apply to the PARSOM ATTIRE website, customer account area, product pages, checkout flow, support forms, and order communication.',
      ...
      'PARSOM ATTIRE may update these terms when business operations, platform features, payment rules, or legal requirements change.',
    ],
  },
  {
    ...
    points: [
      ...
      'PARSOM ATTIRE reserves the right to refuse, limit, or cancel orders that appear fraudulent, abusive, unauthorized, or intended for misuse.',
    ],
  },
  {
    title: 'Payments',
    points: [
      ...
      'Payment gateway charges, convenience fees, or bank-side charges may not be refundable unless required by applicable rules or unless the issue was caused by PARSOM ATTIRE.',
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'If a wrong size is selected by the customer, PARSOM ATTIRE may not accept return or exchange after delivery.',
  ...
  },
  {
    ...
    points: [
      ...
      'If no valid unboxing video is provided, PARSOM ATTIRE may reject the return, exchange, or refund request.',
  ...
  },
  {
    ...
    points: [
      ...
      'All website content, product media, branding, design assets, written content, and layout remain the property of PARSOM ATTIRE unless otherwise stated.',
  ...
  },
  {
    title: 'Support',
    points: [
      'Customers can contact PARSOM ATTIRE through the official support email, contact form, or WhatsApp channel listed on the website.',
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      intro="These terms explain how PARSOM ATTIRE handles website use, orders, payments, product details, returns, exchanges, and customer account activity."
      sections={sections}
    />
  );
}
